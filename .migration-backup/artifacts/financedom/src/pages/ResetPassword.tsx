    ...
    return (
      <div className="min-h-screen bg-[#F1F4FA] flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-[#0D1F3C] mb-2">Lien invalide</h2>
          <p className="text-[#6B7896] text-sm mb-4">Ce lien de réinitialisation est invalide ou a expiré.</p>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#DDE2EC] shadow-xl p-8">
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-xl font-extrabold text-[#0D1F3C] mb-3">Mot de passe modifié !</h2>
            ...
            <>
              <div className="mb-7">
                ...
                <h1 className="text-2xl font-extrabold text-[#0D1F3C] mb-1">Nouveau mot de passe</h1>
                <p className="text-[#6B7896] text-sm">Choisissez un mot de passe sécurisé d'au moins 8 caractères.</p>
              </div>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  <label className="block text-sm font-semibold text-[#0D1F3C] mb-2">Nouveau mot de passe</label>
                  ...
                  {password && !isStrong && (
                    <p className="text-red-500 text-xs mt-1.5">Minimum 8 caractères requis.</p>
                  )}
                </div>
        ...
        <div className="mt-5 flex items-center justify-center">
          <span className="flex items-center gap-1.5 text-xs text-[#A0AABF]">
            <Shield className="w-3 h-3" /> Lien sécurisé · Valide 1 heure
          </span>
        </div>
      </div>
    </div>
