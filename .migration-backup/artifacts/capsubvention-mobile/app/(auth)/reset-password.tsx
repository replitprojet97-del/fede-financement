          ...
          <View style={styles.card}>
            {success ? (
              ...
              <View style={styles.successBox}>
                ...
                <Text style={styles.successText}>Ce lien de réinitialisation est invalide ou a expiré.</Text>
                <TouchableOpacity style={styles.loginBtn} onPress={() => router.replace("/(auth)/forgot-password")}>
                  <Text style={styles.loginBtnText}>Demander un nouveau lien</Text>
                </TouchableOpacity>
              </View>
            ) : (
              <>
                <Text style={styles.cardTitle}>Nouveau mot de passe</Text>
                <Text style={styles.cardSub}>Choisissez un mot de passe sécurisé d'au moins 8 caractères.</Text>
