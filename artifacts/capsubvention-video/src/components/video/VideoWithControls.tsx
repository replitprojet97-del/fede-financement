      ...
      {sceneKeys.map((key, i) => {
        ...
        return (
          <button
            ...
            aria-label={t("video.jump_to_scene", { n: i + 1 })}
  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? t("video.loop_on") : t("video.loop_off")}
        aria-label={locked ? t("video.loop_on") : t("video.loop_off")}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={muted ? t("video.narration_on") : t("video.narration_off")}
        aria-label={muted ? t("video.narration_on") : t("video.narration_off")}
        aria-pressed={!muted}
      >
      ...
      <button
        ...
        title={collapsed ? t("video.show_controls") : t("video.hide_controls")}
        aria-label={collapsed ? t("video.show_controls") : t("video.hide_controls")}
...
export default function VideoWithControls() {
  ...
  if (!isIframed) return <VideoTemplate muted={muted} />;
